...
import 'package:energy_park/modules/complete_task/presentation/bloc/complete_task_bloc.dart';
import 'package:energy_park/modules/complete_task/presentation/bloc/complete_task_event.dart';
import 'package:energy_park/modules/complete_task/presentation/bloc/complete_task_state.dart'
    as completed_task_state;
import 'package:energy_park/modules/home/data/model/task_model.dart';
import 'package:energy_park/modules/home/presentation/bloc/home_bloc.dart';
import 'package:energy_park/modules/add_task/presentation/screen/add_task_screen.dart';
import 'package:energy_park/modules/home/presentation/bloc/home_event.dart';
import 'package:energy_park/modules/task_filter/presentation/task_filter_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (context) => HomeBloc()..add(GetTaskList())),
        BlocProvider(
                                          ...
                                          Expanded(
                                            child: Container(
                                              ...
                                              child: Center(
                                                child: Text(
                                                    pendingTaskCount != 0
                                                        ? 'Your team have [ $pendingTaskCount ] pending task out of [ ${completedTaskCount + pendingTaskCount} ]'
                                                        : 'Congratulations! Your team has completed all the tasks.',
                                                    style: TextStyles
                                                        .whiteRegular14),
                                              ),
                                            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      "Assigned to ${task.employee != null ? task.employee!.name : ""}",
